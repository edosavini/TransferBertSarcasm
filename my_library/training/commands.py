...
from my_library.training.train_multitask import TrainMultiTask
from my_library.training.transfer import Transfer
...
def main(prog: str = None,
    ...
    subcommands = {
            ...
            "configure": Configure(),
            "train": Train(),
            "train_multitask": TrainMultiTask(),  # includes the auxillary emotion section prediction task
