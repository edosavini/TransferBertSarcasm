...
class Transfer(Subcommand):
    def add_subparser(self, name: str, parser: argparse._SubParsersAction) -> argparse.ArgumentParser:
        ...
        subparser.add_argument('--transfer-model',
                               type=str,
                               required=True,
                               help='path to the intermediate model weights to be transferred')
...
def train_model_from_file(parameter_filename: str,
    ...
    return train_model(params, serialization_dir, transfer_model, file_friendly_logging, recover, force)
...
def train_model(params: Params,
    ...
    prev_state_dict = torch.load(transfer_model, map_location='cpu')
